                        ...
                        <table width="100%" style="border-spacing:0;">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <h1 class="req">Feed created by your connection
                                    </h1>
                                    <p class="lorem">Hello <b>{{$username}} </b>,

                                        Your connection <b>{{$connection_username}}</b> has created a new feed.</p>

                                     <p class="lorem"> To view the feed click the following link
                                        <a href="{{$link}}">Link</a>
                                        </p>
                                </td>
                            </tr>
