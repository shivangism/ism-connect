                ...
                <tr>
                    <td>
                        <table width="100%" style="border-spacing:0;">
                            ...
                            <tr>
                                <td>
                                    <img src="https://drive.google.com/uc?id=1jZMdej6Ea5oYiKNPSA-XDljnDbgHS5P9" alt="done" style="width:100px" class="tick" />
                                    <h1 class="req">Forgot your password?
                                    </h1>
                                    <p class="lorem">Hello <b>{{$username}} </b>,

                                        There was a request to change your password! If you did not make this request
                                        then please ignore this email.</p>
