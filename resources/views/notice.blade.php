                ...
                <tr>
                    <td>
                        <table width="100%" style="border-spacing:0;">
                            ...
                            <tr>
                                <td>
                                    <img src="https://drive.google.com/uc?id=1q6YuyhE5nyJ1xRHR3anEejTtMKdJmM0a" alt="done" style="width:100px" class="tick" />
                                    <h1 class="req">New messages awaits your response</h1>
                                    <p class="lorem"> Hello <b>{$username} </b>,you have got 12 new messages. To view messages click below.
                                    </p>
